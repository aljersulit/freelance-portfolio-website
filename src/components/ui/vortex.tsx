...
export const Vortex = (props: VortexProps) => {
  ...
  const initParticle = useCallback(
    ...
    [baseHue, baseRadius, baseSpeed, center, rangeRadius, rangeSpeed, rangeY],
  );
  ...
  const draw = useCallback(
    ...
    [backgroundColor, particlePropsLength, TAU, initParticle, noise3D],
  );
  ...
  }, [draw, center, initParticle, particlePropsLength]);
  ...
  return (
    <div className={cn('relative h-full w-full', props.containerClassName)}>
      ...
      <div className={cn('relative z-20', props.className)}>{props.children}</div>
    </div>
  );
};

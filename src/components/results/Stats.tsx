  ...
  return (
    <section className='py-[24px] lg:py-[40px] xl:py-[20px] 3xl:py-[60px]'>
      <div className='justify-end lg:flex lg:gap-[50px] lg:pl-[30px] xl:gap-[62px] xl:pl-[96px] 3xl:gap-[112px] min-[2100px]:gap-[148px]'>
        <header className='px-[22px] lg:w-1/4 3xl:max-w-[470px]'>
          <h2
          ...
          <div className='ml-auto mt-[24px] flex h-full w-11/12 flex-col justify-center gap-[20px] pl-[26px] lg:ml-0 lg:mt-0 lg:w-full lg:items-end lg:gap-[58px] lg:pb-[80px] xl:gap-[72px] 3xl:pb-[160px]'>
            <div className='w-fit xl:w-[244px] 3xl:w-[325px]'>
              <Percentage value={990} />
              <p className='text-sm lg:max-w-[200px] xl:mt-[10px] xl:max-w-[238px] xl:pl-[46px] xl:text-2xl 3xl:max-w-[300px] 3xl:text-3xl'>
        ...
        <Image
          ...
          className='ml-auto mt-[24px] w-11/12 object-contain lg:mt-0 lg:w-8/12'
        />
      </div>

      <div className='relative mt-[34px] justify-center px-[22px] lg:mt-[60px] lg:flex lg:gap-[36px] lg:px-0 xl:mt-[88px] xl:gap-[62px] 3xl:gap-[78px] min-[2100px]:mt-[128px] min-[2100px]:gap-[118px]'>
        <div className='lg:max-w-[440px] xl:max-w-[666px] 3xl:max-w-[850px]'>
          <div className='rounded-md border-2 border-primary bg-secondary px-[10px] py-[18px] lg:rounded-lg lg:px-[40px] lg:py-[54px] xl:rounded-xl xl:px-[56px] xl:py-[68px] 3xl:rounded-2xl 3xl:py-[78px]'>
            <h3 className={`${playfairDisplay.className} text-center lg:text-3xl xl:text-[2.5rem]`}>
              Facebook Reels Result
            </h3>
            <Image src={FBReelsResult} alt='Facebook Reels Result' className='mt-[10px] lg:mt-[22px] xl:mt-[30px]' />
          </div>
          <p className='mt-[6px] text-xs text-muted-foreground lg:mt-[10px] lg:w-5/6 lg:text-xs xl:mt-[16px] xl:text-sm 3xl:text-xl'>
        ...
        <div className='mt-[14px] rounded-md border-2 border-primary bg-secondary px-[10px] py-[18px] lg:mt-[28px] lg:max-w-[400px] lg:rounded-lg lg:px-[16px] lg:py-[44px] xl:mt-[40px] xl:max-w-[592px] xl:rounded-xl xl:px-[18px] xl:py-[90px] 3xl:max-w-[718px] 3xl:rounded-2xl 3xl:pb-[50px]'>
          <h3 className={`${playfairDisplay.className} text-center lg:text-3xl xl:text-[2.5rem]`}>
            Facebook Content Result
          </h3>
          <Image src={FBContentResult} alt='Facebook Content Result' className='mt-[8px] lg:mt-[30px] xl:mt-[48px]' />
        </div>
        <div
      ...
      <div className='mt-[50px] justify-center px-[22px] lg:mt-[74px] lg:flex lg:gap-[58px] lg:px-0 xl:gap-[74px] 3xl:mt-[160px] min-[2100px]:mt-[200px] min-[2100px]:gap-[94px]'>
        <div className='w-fit flex-col justify-center lg:flex lg:pb-[96px] xl:pb-[120px] 3xl:pb-[162px]'>
          <Percentage value={30} />
          <p
            className={`${roboto.className} text-sm font-normal text-[#757575] lg:max-w-[266px] lg:pl-[22px] lg:text-lg/tight xl:mt-[10px] xl:max-w-[360px] xl:pl-[30px] xl:text-2xl/none 3xl:text-3xl/tight`}
          >
        ...
        <div className='mt-[10px] lg:mt-0 lg:max-w-[460px] xl:max-w-[578px] 3xl:max-w-[880px]'>
          ...
          <p className='mt-[8px] text-pretty text-[0.65rem] text-[#757575] lg:mt-[12px] lg:text-xs xl:mt-[20px] xl:text-sm 3xl:text-lg'>
      ...
      <div className='mt-[50px] flex-row-reverse justify-end lg:mt-[58px] lg:flex lg:gap-[30px] 3xl:mt-[140px]'>
        <div className='flex flex-col justify-center px-[22px] lg:space-y-[30px] lg:pb-[54px] 3xl:space-y-[40px] 3xl:pb-[104px]'>
        ...
        <Image
          ...
          className='mt-[14px] w-11/12 object-contain lg:mt-0 lg:w-2/3'
        />
      </div>

      <div className='mt-[40px] items-end justify-center px-[22px] lg:mt-[90px] lg:flex lg:gap-[50px] xl:mt-[110px] xl:gap-[120px]'>
        <div className='rounded-md border-2 border-primary bg-secondary px-[10px] py-[18px] lg:max-w-[450px] lg:rounded-lg lg:p-[26px] lg:pb-[8px] xl:max-w-[627px] xl:rounded-xl xl:p-[36px] xl:pb-[18px] 3xl:max-w-[880px] 3xl:p-[50px] 3xl:pb-[22px]'>
        ...
        <div className='mt-[20px] border-t border-[#000000] px-[4px] pt-[14px] lg:mt-0 lg:max-w-[340px] lg:border-l lg:px-0 lg:py-[16px] lg:pl-[20px] lg:pt-0 xl:max-w-[420px] xl:py-[26px] xl:pl-[32px] 3xl:max-w-[580px]'>
          <p
            className={`${roboto.className} text-balance text-xs tracking-tight lg:text-pretty lg:text-xs xl:text-sm 3xl:text-lg`}
          >
            {TESTIMONIALS[0].quote}
          </p>
          <div className='mt-[10px] flex gap-[12px] lg:mt-[8px] lg:gap-[10px] xl:mt-[12px] xl:gap-[18px]'>
            <Image
              src={TESTIMONIALS[0].src}
              alt={TESTIMONIALS[0].name}
              className='max-w-[100px] lg:max-w-[74px] xl:max-w-[90px] 3xl:max-w-[132px]'
            />
            <div
...
function Percentage({
  ...
  return (
    <div className={cn('flex items-center font-semibold leading-none text-analytics', className)}>
      <ArrowUp className={cn('inline w-[18px] lg:w-[24px] xl:w-[30px] 3xl:w-[46px]', arrowClassName)} />
      <p className={cn(outfit.className, 'text-4xl lg:text-7xl xl:text-8xl 3xl:text-9xl', valueClassName)}>
        {formattedValue}
        <span
          className={cn(
            'relative align-top text-2xl lg:top-[0.5rem] lg:text-5xl xl:text-6xl 3xl:top-[1.25rem] 3xl:text-7xl',
            percentClassName,
          )}
        >
          %

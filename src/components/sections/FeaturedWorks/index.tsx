...
export default async function FeaturedWorks() {
  ...
  return (
    <section
      id='works'
      className='rounded-t-3xl bg-secondary px-[20px] py-[26px] md:rounded-t-[3.3rem] md:px-[35px] md:py-[50px] lg:px-[80px] lg:py-[96px]'
    >
      ...
      {WORKS.worksList.length > 0 ? (
        ...
        <div className='flex h-lvh items-center justify-center'>
          <p className='text-gray-400'>No Feature Works data available.</p>
        </div>
      )}
    </section>
  );

  ...
  return (
    ...
    >
      <header className='relative z-10'>
        <h2
          className={`${roboto.className} border-b-2 border-b-stone-300 pb-4 text-lg uppercase text-secondary-foreground md:text-4xl lg:text-5xl xl:text-6xl`}
        >
          About me
        </h2>
        <div className='relative mt-[22px] flex justify-center gap-4 md:mt-[54px] xl:mt-[78px]'>
          <div className='absolute hidden lg:relative lg:block lg:w-[460px]'>
          ...
          <div className='flex flex-col justify-center lg:w-4/6 xl:w-[758px]'>
            <h3
              className={`${roboto.className} text-balance text-3xl font-semibold leading-[1.2] min-[375px]:text-4xl md:text-5xl lg:text-4xl xl:text-5xl`}
            >
              Digital Marketing Strategist and Creative Designer
            </h3>
            <div className='mt-[15px] text-pretty text-[0.625rem] leading-[1.3] text-muted-foreground min-[375px]:text-xs min-[425px]:text-sm md:mt-[38px] md:text-lg lg:text-sm xl:mt-[28px] xl:text-[1rem]'>
              <p>
      ...
      <article className='relative z-10 mt-[18px] flex-col justify-center gap-[15px] text-[0.625rem] text-muted-foreground min-[375px]:text-xs min-[425px]:text-sm md:mt-[22px] md:text-lg lg:mt-0 lg:flex lg:flex-row lg:items-end lg:gap-[42px] lg:text-sm xl:gap-[76px]'>
        <div className='flex flex-col-reverse gap-[15px] lg:w-[400px] lg:flex-col lg:gap-0 xl:w-[662px]'>
          <p>
        ...
        <div className='mt-[18px] lg:mt-[0px] lg:w-[400px] xl:w-[542px]'>
          <ul>
            <li>
              <Image
                src={img1list2}
      ...
      <div className='absolute left-0 top-0 z-0 h-full w-full bg-[url(/purple_gradient_about.png)] bg-contain bg-no-repeat opacity-45 md:w-[619px] lg:opacity-100 2xl:w-2/3' />
      <div className='absolute right-0 top-0 z-0 h-full w-full bg-[url(/yellow_gradient_about.png)] bg-contain bg-right-bottom bg-no-repeat opacity-75 md:w-[619px] lg:bg-right-top lg:opacity-100 2xl:w-2/3' />
    </section>
  );
}
